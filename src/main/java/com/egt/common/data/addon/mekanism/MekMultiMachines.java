...
public class MekMultiMachines {
    ...
    public static final MultiblockMachineDefinition EVAPORATION = REGISTRATE
            ...
            .pattern(def -> FactoryBlockPattern.start()
                    .aisle("AAAA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA",
                            "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "AAAA")
                    .aisle("AAAA", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B",
                            "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "A##A")
                    .aisle("AAAA", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "B##B",
                            "B##B", "B##B", "B##B", "B##B", "B##B", "B##B", "A##A")
                    .aisle("AAAA", "AB$A", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA",
                            "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "ABBA", "AAAA")
                    .where('$', controller(blocks(def.get())))
